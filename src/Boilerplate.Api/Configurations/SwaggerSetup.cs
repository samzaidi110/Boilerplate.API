...
public static class SwaggerSetup
{
    ...
    public static IApplicationBuilder UseSwaggerSetup(this IApplicationBuilder app, bool isDevelopment)
    {
        string swaggerEndpoint = isDevelopment ? "/swagger/v1/swagger.jsons" : "https://dev-api.anchoragesource.com/solv-project_name-api/swagger/v1/swagger.json";
